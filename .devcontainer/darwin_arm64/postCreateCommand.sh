...
pushd /tmp
wget https://github.com/junegunn/fzf/releases/download/0.51.0/fzf-0.51.0-linux_arm64.tar.gz
tar xf fzf-0.51.0-linux_arm64.tar.gz
sudo mv fzf /usr/local/bin/
rm fzf-0.51.0-linux_arm64.tar.gz
popd
